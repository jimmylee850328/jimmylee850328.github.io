...
export default function RootLayout({
  ...
  const JobTitleBadge = ({ size = 'normal' }: { size?: 'normal' | 'small' }) => (
    <div className={`
  ...
  const LocationDisplay = ({ size = 'normal' }: { size?: 'normal' | 'small' }) => (
    <div className={`
  ...
  const ContactCard = ({ compact = false }) => (
    <div className={`flex ${compact ? "gap-3" : "gap-4"} justify-center`}>
      ...
      >
        <svg className={`${compact ? "w-5 h-5" : "w-5 h-5"}`} fill="currentColor" viewBox="0 0 24 24">
  ...
  const Avatar = ({ size, centered = false }: { size: 'small' | 'medium' | 'large'; centered?: boolean }) => {
                ...
                <aside className="w-[380px] flex-shrink-0">
                  <div className="bg-card-dark rounded-2xl p-8 border border-border-dark shadow-lg fixed w-[380px] h-fit">
                    ...
                    <div className="text-center mb-8">
                      ...
                      <h1 className="text-2xl font-bold text-text-primary mb-4">Jimmy Lee</h1>
            ...
            <div className="px-16 py-8 max-w-4xl mx-auto">
              ...
              <div className="bg-card-dark rounded-2xl px-16 py-8 border border-border-dark shadow-lg mb-8 relative overflow-hidden">
                <div className="flex items-center space-x-4">
                  <Avatar size="medium" />
                  <div>
                    <h1 className="text-xl font-bold text-text-primary mb-3">Jimmy Lee</h1>
                    <div className="mb-2">
            ...
            <div className="p-3">
              ...
              <div className="bg-card-dark rounded-2xl p-4 border border-border-dark shadow-lg mb-3">
                <div className="flex items-center space-x-3">
                  <Avatar size="small" />
                  <div>
                    <h1 className="text-lg font-bold text-text-primary mb-2">Jimmy Lee</h1>
                    <div className="mb-1">
                      <JobTitleBadge size="small" />
                    </div>
                    <LocationDisplay size="small" />
