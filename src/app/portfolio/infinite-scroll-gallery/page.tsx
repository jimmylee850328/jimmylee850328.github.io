      ...
      <div className="mb-12">
        ...
        <div className="bg-card-dark p-6 rounded-xl border border-border-dark mb-8">
          <p className="text-text-secondary mb-4">
            A React-based infinite scroll gallery that fetches random dog images from the Dog API. 
            This project demonstrates API integration, infinite scrolling, performance optimization, 
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {['React', 'TypeScript', 'Next.js', 'Tailwind CSS', 'Dog API', 'Infinite Scroll'].map((tech) => (
                  <span 
                    key={tech}
          ...
          >
            <Image 
              ...
              className="w-full h-auto object-cover group-hover:scale-105 transition-transform duration-300"
                  ...
                  const imgElement = document.querySelector(`[src="${imageUrl}"]`) as HTMLElement
