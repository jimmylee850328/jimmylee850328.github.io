...
export default function TypewriterQuote({ className = '' }: TypewriterQuoteProps) {
  ...
  if (!isMounted) {
    return <div className={`${className} h-10 sm:h-12 xl:h-16 flex items-center justify-center`}>
      <div className="text-hover-dark font-medium">Loading...</div>
    </div>
  }

  return (
    <div className={`${className} h-10 sm:h-12 xl:h-16 flex items-center justify-center`}>
